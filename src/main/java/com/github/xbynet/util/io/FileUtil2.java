...
import com.github.xbynet.annotation.NotNull;
import com.github.xbynet.annotation.Nullable;
import com.github.xbynet.util.Platforms;
...
public class FileUtil2 {
	...
	public static void copyFile(@NotNull File from, @NotNull File to) throws IOException {
		...
		Validate.notNull(to);
		Validate.isTrue(!FileUtil2.isDirExists(to), to + " is exist but it is a dir");
		Files.copy(from, to);
	}
